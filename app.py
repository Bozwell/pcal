    ...
    if request.method == 'POST':
        ...
        if option == 'percentage_of_total':
            ...
            return jsonify({
                ...
                result,
                'calculation':
                '전체값의 {}%는 {:.2f}'.format(percentage, result)
            })
            ...
            return jsonify({
                ...
                percentage,
                'calculation':
                '전체값에서 {:.2f}은 {:.2f}%입니다.'.format(part_value, percentage)
            })
            ...
            return jsonify({
                ...
                'calculation':
                '값이 {:.2f}에서 {:.2f}로 {:.2f}% {}했습니다.'.format(
                    old_value, new_value, abs(percentage_change), change_type)
            })
        ...
        if 'cidr_input' in request.form:
            ...
            try:
                ...
                return jsonify({
                    ...
                    2  # Excluding network and broadcast addresses
                })
